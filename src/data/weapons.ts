...
export const WEAPONS: Record<WeaponId, Weapon> = {
  ...
  bow: {
    ...
    combo: {
      ...
      name: '연사',
      tags: ['공격', '투사체', '물리'],
      base: { damage: 36, projectileCount: 5, projectileSpeed: 520 },
      supportSlots: 2,
    },
  },
  ...
  arcane: {
    ...
    combo: {
      ...
      name: '비전단검',
      tags: ['공격', '투사체', '주문'],
      base: { damage: 32, projectileCount: 6, projectileSpeed: 560 },
      supportSlots: 2,
    },
  },
  ...
  shield: {
    ...
    combo: {
      ...
      name: '균열 파동',
      tags: ['공격', '지대', '물리', '지속시간'],
      base: { damage: 34, areaRadius: 150, duration: 2.4, tickInterval: 0.4 },
      supportSlots: 2,
    },
  },
};
